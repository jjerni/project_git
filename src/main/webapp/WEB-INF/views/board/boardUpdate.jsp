...
<script type="text/javascript">
    ...
    function getBoardDetailCallback(obj){
        ...
        if(obj != null){                                
            ...
            var boardSeq        = obj.boardSeq; 
            var boardReRef      = obj.boardReRef; 
            var boardReLev      = obj.boardReLev; 
            var boardReSeq      = obj.boardReSeq; 
            var boardWriter     = obj.boardWriter; 
            var boardSubject    = obj.boardSubject; 
            var boardContent    = obj.boardContent; 
            var boardHits       = obj.boardHits;
            var delYn           = obj.delYn; 
            var insUserId       = obj.insUserId;
            var insDate         = obj.insDate; 
            var updUserId       = obj.updUserId;
            var updDate         = obj.updDate;
